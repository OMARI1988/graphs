...
f = open('/home/omari/catkin_ws/src/graphs/src/grounding.txt', 'w')
...
class simpleapp_tk(Tkinter.Tk):
	...
	f.write(self.entryVariable.get()+msg+'\n')
	...
	global f
	print 'Reading file ...'
	f = open('/home/omari/catkin_ws/src/graphs/src/grounding.txt', 'r')
...
if __name__ == "__main__":
    ...
    app.title('Grounding Language')

    print('Grounding Language running...  ')
